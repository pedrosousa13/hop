...
- The durable author-facing boundary is the [v1 theme token contract](../../theme-token-contract.md); this historical design remains the source decision for the broader theme ecosystem.
